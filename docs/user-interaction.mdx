...
You can can use the [Javascript API](js-api#subscribe) to subscribe to the mouse-related events: "mouseOver", "rangeSelect", "click" to create custom interactions with the visualization.
