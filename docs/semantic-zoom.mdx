...
<a href="http://gosling-lang.org/docs/composition#align-multiple-tracks-in-one-view" target="_blank">alignment</a> allow users to overlap multiple marks on top of one other, thus allowing users to create different visualizations for the same data.
...
<TableWrapper objName='SizeVisibilityCondition' />

### Control Visibility through Zoom Level
<TableWrapper objName='ZoomLevelVisibilityCondition' />
