...
When connections between points on **different chromosomes** need to be created, the *genomicFieldsToConvert* property should be used at the time of loading data. **NB: currently this property is experimental; use it with caution.**
...
```javascript
    {
        "tracks": [{
            "title": "Visualization with csv loaded via url",
            "data": {
                "url": "https://solo7773.github.io/rearrangement.test.txt",
                "type": "csv",
...
[Try it in the online editor](<https://gosling.js.org/?gist=solo7773/82a8a75855d1d3b773acbf7d66468d06>)
