...
can create one using [tabix](http://www.htslib.org/doc/tabix.html). Otherwise, you can treat BED file as if it were a 
CSV file and use the CSV data specification.
