...
<TableWrapper GoslingSchema={GoslingSchema} objName='VCFData' includeDescription/>
...
### Genomic Length Transform

<TableWrapper GoslingSchema={GoslingSchema} objName='GenomicLengthTransform' includeDescription={true}/>

### SV Type Transform

<TableWrapper GoslingSchema={GoslingSchema} objName='SvTypeTransform' includeDescription={true}/>
