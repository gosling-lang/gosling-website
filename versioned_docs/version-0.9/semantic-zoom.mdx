...
<a class='imageBlock' href="https://gosling-lang.github.io/gosling.js/?example=doc_semantic_zoom_sequence" target='_blank'>
  <img src="/img/doc_images/semantic_zoom_0.png" alt="semantic_zoom_coarse" width="700"/>  
  <br/>
  <span class='caption'><b>Zoom Out:</b> `text` marks are hidden. The stacked bar chart shows the proportion of the four DNA bases. </span>
  
  <img src="/img/doc_images/semantic_zoom_1.png" alt="semantic_zoom_fine" width="700"/>
  <br/>
  <span class='caption'><b>Zoom In:</b> only `rect` marks are represented.</span>
</a>
...
<a class='imageBlock' href="https://gosling-lang.github.io/gosling.js/?example=doc_semantic_zoom_cyto" target='_blank'>
  <img src="/img/doc_images/semantic_zoom_2.png" alt="semantic_zoom_coarse" height="60" width="700"/>  
  <br/>
  <span class='caption'><b>Zoom Out:</b> Only rect marks are represented. </span>

  <img src="/img/doc_images/semantic_zoom_3.png" alt="semantic_zoom_fine" height="60" width="700"/> 
  <br/>
  <span class='caption'><b>Zoom In:</b> text and triangle marks are presented when zooming in to show more details</span>
</a>
