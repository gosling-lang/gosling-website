...
<a href="https://gosling-lang.github.io/gosling.js/?example=RULE">
    <img src="https://raw.githubusercontent.com/gosling-lang/gosling.js/da5a0c65b384f7ad13f149e386a4238711517162/editor/example/thumbnails/RULE.png"
    width="400" alt="rule_example"/>  
</a>

[Try it in the online editor](<https://gosling-lang.github.io/gosling.js/?example=RULE>)

```javascript
{
  "tracks": [
    /********************
    * a rule track that draws three vertical reference lines
    ********************/
    {
        "mark": "rule",
        "x": {"field": "p", "type": "genomic"}, 
        // define the position of the three reference lines
        "data": {
            "type": "json",
            "values": [
                {"c": "chr2", "p": 100000},
            ...
            // define the styles of the reference lines
            "strokeWidth": {"value": 2},
            "color": {"value": "blue"}
    },
    { /** another track */ },
...
<a href="https://gosling-lang.github.io/gosling.js/?gist=wangqianwen0418/b061daf712940f5827f0c1e9c95d368b">
    <img src="/img/doc_images/rule_anno_example.png"
    width="600" alt="rule_example"/>  
</a>

[Try it in the online editor](<https://gosling-lang.github.io/gosling.js/?gist=wangqianwen0418/b061daf712940f5827f0c1e9c95d368b>)
    ...
    *********************/
    {
        "data": {...},
        "mark": "rule",
        // one rule mark encodes the start and end postion of a gene
        "xe": {"field": "end", "type": "genomic"},
        "x": {"field": "start", "type": "genomic"},
        // style of the rule mark
        "strokeWidth": {"value": 3},
