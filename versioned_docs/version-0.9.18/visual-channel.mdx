...
<h4 id ='typeeventstyle'> Properties of EVENTSTYLE</h4>
<TableWrapper GoslingSchema={GoslingSchema} objName="EventStyle" includeDescription/>

<h4 id ='typeeventstyle'> Properties of BRUSH</h4>
<TableWrapper GoslingSchema={GoslingSchema} objName="Style-properties-brush" includeDescription /> 