...
const floatingWindow = <div className={styles.floatingNews}>
  ...
  <ul>
    <li>We released Gosling <a href='https://github.com/gosling-lang/gosling.js/releases/tag/v1.0.0' class='primary-color'>v1.0.0</a>! Read more in the <a href='/blog/v1-release' class='primary-color'>announcement blog post</a>.</li>
